...
# However it is being used in campusconnect/inventory/models/models_all.py
# In two classes
...
MODELNAME_DISPLAYNAME_DICT_PRODUCTS_THAT_WORK_IN_CART_SYSTEM = {
    'mprod_prei20'      :        "PreI-20",
    'mprod_visaassist'  :        "Visaassist",
    'mprod_univcom'     :        "Univcom",
    'mprod_posti20'     :        "PostI-20",
