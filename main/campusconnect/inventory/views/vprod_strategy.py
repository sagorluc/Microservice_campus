...
from inventory.models.strategy.mprod_strategy import (
    mprod_strategy, 
)
...
PATH_PRODUCT_LAYOUT     = "inventory/layout/products/strategy/"
PATH_ROOT               = os.path.join(settings.BASE_DIR)
PATH_PRODUCT_COMPONENT  = 'general/components/menus/products/strategy'
